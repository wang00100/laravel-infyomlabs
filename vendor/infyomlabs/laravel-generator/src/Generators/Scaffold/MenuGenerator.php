...
class MenuGenerator extends BaseGenerator
{
    ...
    public function generate()
    {
        ...
        if (Str::contains($existingMenuContents, '<p data-name="'.$this->commandData->config->mHumanPlural.'" >') or
            Str::contains($existingMenuContents, '<span data-name="'.$this->commandData->config->mHumanPlural.'" >' )) {
