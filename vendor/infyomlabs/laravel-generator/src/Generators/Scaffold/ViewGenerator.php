...
class ViewGenerator extends BaseGenerator
{
    ...
    private function generateBladeTableBody()
    {
        ...
        foreach ($this->commandData->fields as $field) {
            ...
            if (strpos($field->htmlType,'vince.fields.avatar') !== false){
              $cellFieldTemplate = get_template('vince.views.table_cell.avatar', $this->templateType);
            }else if (strpos($field->htmlType,'vince.fields.select') !== false){
              $cellFieldTemplate = get_template('vince.views.table_cell.select', $this->templateType);
              $cellFieldTemplate = str_replace('$DATA_URL$', $field->data_url, $cellFieldTemplate);
            }
    ...
    private function generateShowFields()
    {
        ...
        foreach ($this->commandData->fields as $field) {
            ...
            $fieldTemplate = get_template('scaffold.views.'.$templateName, $this->templateType);
            if (strpos($field->htmlType,'vince.fields.avatar') !== false){
              $fieldTemplate = get_template('vince.views.show_field.avatar', $this->templateType);
            }else if (strpos($field->htmlType,'vince.fields.select') !== false){
              $fieldTemplate = get_template('vince.views.show_field.select', $this->templateType);
              $fieldTemplate = str_replace('$DATA_URL$', $field->data_url, $fieldTemplate);
            }
