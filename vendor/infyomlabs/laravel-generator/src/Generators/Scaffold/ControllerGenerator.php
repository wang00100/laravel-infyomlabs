...
class ControllerGenerator extends BaseGenerator
{
    ...
    public function generate()
    {
        if ($this->commandData->getAddOn('datatables')) {
            ...
            if ($paginate) {
                $templateData = str_replace('$RENDER_TYPE$', 'paginate('.$paginate.',$request->except([\'page\']))', $templateData);
            } else {
                $templateData = str_replace('$RENDER_TYPE$', 'all($request->except([\'page\']))', $templateData);
            }
        }
